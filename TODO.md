...
- [ ] 设置标签时，在下拉菜单点击标签项整个软件界面会白屏，需要修复
- [ ] 在列表视图下，查看集合图片时，当某个图片height > width时，会导致图片显示越界，需要修复
- [ ] 当查看图片详情时，如果图片的height > width，图片显示位置会偏下，且显示不全，无法滚轮移动视角，需要修复
- [ ] 加载合集时可以懒加载，避免一次性加载太多的合集导致界面卡顿
- [ ] 筛选功能有问题，无法应用搜索，需要修复或者去掉该功能
